...
/**
 * 专题界面语言选择Spinner的Adapter
 * Created by Brioal on 2016/7/10.
 */

public class FraSubSpinnerLanguageAdapter implements SpinnerAdapter {

    private Context mContext;
    private List<LanguageEntity> mList;

    public FraSubSpinnerLanguageAdapter(Context context, List<LanguageEntity> list) {
        mContext = context;
        mList = list;
    }
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        LanguageEntity entity = mList.get(position);
        holder.mIcon.setmText(entity.getSubjectCount() + "");
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.mIcon.setmText(entity.getSubjectCount() + "");
        holder.mTitle.setText(entity.getTitle());
        convertView.setBackgroundResource(R.drawable.home_fra_btn_left_top);
        return convertView;
    }
    ...
    public void notifiedDataChange(List<LanguageEntity> list) {
        mList = list;
    }
